...
#ifndef Algoriscope_private_rc
#define Algoriscope_private_rc
...
#define ORIGINAL_FILENAME	"Algoriscope.exe"
#define PRODUCT_NAME	"Algoriscope"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*Algoriscope_private_rc*/
